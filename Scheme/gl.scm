...
(define glGenTextures (c-lambda (GLsizei (c-pointer GLuint)) void "glGenTextures"))
(define glBindTexture (c-lambda (GLenum GLuint) void "glBindTexture"))
(define glTexImage2D (c-lambda (GLenum GLint GLenum GLsizei GLsizei GLint GLenum GLenum (c-pointer GLvoid)) void "glTexImage2D"))
...
(define glNormalPointer (c-lambda (GLenum GLsizei (c-pointer GLvoid)) void "glNormalPointer"))
(define glTexCoordPointer (c-lambda (GLint GLenum GLsizei (c-pointer GLvoid)) void "glTexCoordPointer"))
...
(define glDrawElements (c-lambda (GLenum GLsizei GLenum (c-pointer GLvoid)) void "glDrawElements"))
...
(define glMultMatrixf (c-lambda ((c-pointer GLfloat)) void "glMultMatrixf"))
(define glLoadMatrixf (c-lambda ((c-pointer GLfloat)) void "glLoadMatrixf"))
...
(define glFogfv (c-lambda (GLenum (c-pointer GLfloat)) void "glFogfv"))
(define glFogx (c-lambda (GLenum GLfixed) void "glFogx"))
(define glFogxv (c-lambda (GLenum (c-pointer GLfixed)) void "glFogxv"))
(define glLightf (c-lambda (GLenum GLenum GLfloat) void "glLightf"))
(define glLightfv (c-lambda (GLenum GLenum (c-pointer GLfloat)) void "glLightfv"))
(define glMaterialf (c-lambda (GLenum GLenum GLfloat) void "glMaterialf"))
(define glMaterialfv (c-lambda (GLenum GLenum (c-pointer GLfloat)) void "glMaterialfv"))
(define glShadeModel (c-lambda (GLenum) void "glShadeModel"))
(define glLightModelf (c-lambda (GLenum GLfloat) void "glLightModelf"))
(define glLightModelfv (c-lambda (GLenum (c-pointer GLfloat)) void "glLightModelfv"))
...
;; (define glCallList (c-la1mbda (GLuint) void "glCallList"))
...
(define glClearDepth (c-lambda (GLclampf) void "glClearDepthf"))
